...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_movement', models.CharField(choices=[('Ingreso', 'Ingreso'), ('Egreso', 'Egreso')], max_length=10, verbose_name='Type')),
                ('category', models.CharField(choices=[('Venta', 'Venta'), ('Compra de insumos', 'Compra de insumos'), ('Envío', 'Envío'), ('Otro', 'Otro')], max_length=20, verbose_name='Category')),
                ...
                ('reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='financial_movements', to='order.order', verbose_name='Order Reference')),
            ],
            options={
